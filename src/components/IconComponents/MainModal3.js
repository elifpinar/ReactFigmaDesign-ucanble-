...
const ModalItem = ({ onClick, buttonText1, buttonText2, title, content, number, roomStatus, highlight }) => (
  <Box sx={{ backgroundColor: highlight ? '#555' : '#3A3939', padding: 2 ,borderRadius: '10px'}}>
    <Box position="relative" display="inline-block">
      <Button id="1" variant="contained" style={{ width: 200, height: 200, borderRadius: '10px'  }} onClick={onClick} >
        <img src={houseKeeping} alt="Housekeeping Icon" style={{ width: 50, height: 50 }} />
      </Button>
